...
```js
javascript:void((()=>{let s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/zhaojingwuying/BUPT-empty-classroom-web-plugin@main/src/emptyclassroom.js?v=20260602-v2';document.body.appendChild(s)})())
```
...
```js
javascript:void((()=>{let s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/zhaojingwuying/BUPT-empty-classroom-web-plugin@你的commit哈希/src/emptyclassroom.js?v=20260602-v2';document.body.appendChild(s)})())
```
